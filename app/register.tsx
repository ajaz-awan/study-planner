...
export default function RegisterScreen() {
  ...
  return (
    ...
    >
      ...
      <Text style={[styles.subtitle, { color: colors.subtext }]}>Create Account</Text>
      ...
      <TouchableOpacity style={[styles.btn, { backgroundColor: colors.primary }]} onPress={handleRegister}>
